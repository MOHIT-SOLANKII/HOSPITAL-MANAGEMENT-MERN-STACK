  ...
  return (
    <>
      ...
      <nav className="hidden">
        <ul className="flex flex-col items-center pt-8 space-y-6 bg-gray-200 p-2 h-screen">
          <li className="">
            <NavLink
              to="/"
              className="p-2 mx-2 text-gray-900 hover:text-gray-500"
            >
              Home
            </NavLink>
          </li>
          <li>
            <NavLink
              to="/appointment"
              className="p-2 mx-2 text-gray-800 hover:text-gray-900"
            >
              Appointment
            </NavLink>
          </li>
